...
void HELPS(int s) {
	...
	cout << "| |  | | |____| |____| |     ____) |";
	GotoXY(35, 10);
	cout << "|_|  |_|______|______|_|    |_____/";
	...
	cout << "    ESC:                   PAUSE    ";
	GotoXY(20, 25);
	cout << "Make 5 symbols in a row on a horizontal, diagonal or vertical line before your opponent";
	int x_HELP;
...
void LOADGAME(int s, int& load, char loadg[][100]) {
	...
	cout << "  / ____|                   |  ____(_) |";
	GotoXY(30, 5);
	cout << " | (___   __ ___   _____    | |__   _| | ___  ___";
	GotoXY(30, 6);
	cout << "  \\___ \\ / _` \\ \\ / / _ \\   |  __| | | |/ _ \\/ __|";
	GotoXY(30, 7);
    cout << "  ____) | (_| |\\ V /  __/   | |    | | |  __/\\__ \\";
	GotoXY(30, 8);
    cout << " |_____/ \\__,_| \\_/ \\___|   |_|    |_|_|\\___||___/";                                                
	int x_LG, line_LG = 11;
	bool EXIT_LG = false;
	loadgame();
	printFileName(loadg);
